...
const card = document.querySelector(
  '.research-card[data-id="instance-metrics"]'
);
...
function buildParticles() {
  ...
  for (let i = 0; i < COUNT; i += 1) {
    ...
    aControl1[i3] = rand(-200, 120);
    aControl1[i3 + 1] = rand(120, 260);
    aControl1[i3 + 2] = rand(-260, 260);
    aControl2[i3] = rand(-40, 220);
    aControl2[i3 + 1] = rand(-120, 120);
    aControl2[i3 + 2] = rand(-260, 260);
  ...
  geo.setAttribute(
    "aControl1",
    new THREE.InstancedBufferAttribute(aControl1, 3)
  );
  geo.setAttribute(
    "aControl2",
    new THREE.InstancedBufferAttribute(aControl2, 3)
  );
  geo.setAttribute("aEnd", new THREE.InstancedBufferAttribute(aEnd, 3));
  geo.setAttribute(
    "aAxisAngle",
    new THREE.InstancedBufferAttribute(aAxisAngle, 4)
  );
