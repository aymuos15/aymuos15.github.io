...
function init(canvas) {
  ...
  camera = new THREE.PerspectiveCamera(55, 1, 1, 20_000);
  ...
  water = new Water(new THREE.PlaneGeometry(10_000, 10_000), {
    distortionScale: 3.7,
    fog: false,
    sunColor: 0xff_ff_ff,
  ...
  try {
    ...
    /* the loop paints properly once Research is shown */
  }
  ensureRunning();
